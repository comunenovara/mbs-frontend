...
import { MbsIncentiveCalculationResourceService } from '@mbs-incentive';
...
export class EnzoIncentiveCalculationListPageComponent {
	...
	incentiveCalculationListDc = ['_ck', 'id', 'procurement.code', 'procurement.description', 'description'];
